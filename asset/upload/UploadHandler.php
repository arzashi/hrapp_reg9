...
class UploadHandler
{
    ...
    protected function handle_form_data($file, $index) {
		$directory = $_POST['org'] . '/' . $_POST['user_id'] . '/' . $_POST['timeStamp'];
		
        // Handle form data, e.g. $_POST['description'][$index]
		$this->options['upload_dir'] = $this->options['upload_dir'] . $directory . '/';
		$this->options['upload_url'] = $this->options['upload_url'] . $directory . '/';
    }
