<script src="<?php echo base_url(); ?>asset/js/pages/work_report/approve_level3.js"></script>
<section class="content">
    <div class="row">
        <div class="box box-solid">
			<div class="box-header " >
				<i class="fa fa-check-square-o"></i>
				<h3 class="box-title"> รับทราบรายงานปฏิบัติงาน(ผอ เขต)</h3>
			</div>
					...
					<?php
						foreach ($workReports as $workReport) {
							echo "<tr><td>". $workReport->create_by . 
								...
								"</td><td><div class='form-group'><div class='radio'><label><input type='radio' name='work_type_" . $workReport->id . "' id='work_type_" . $workReport->id . "_1' value='1'>ทราบ </label></div></div>".
