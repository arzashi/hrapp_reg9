<script src="<?php echo base_url(); ?>asset/js/pages/work_report/work_report_summary_hr.js"></script>
...
<section class="content-header">
    <div id="content-form" class="box box-primary box-solid">
        <div class="box-header " data-widget="collapse">
            ...
            <h3 class="box-title">สรุปการมาปฏิบัติงานของ HR</h3>
        </div>
        <div class="box-body">
            <div class="row">
                ...
                <table id="tbl" class="table table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th width="30%" style="text-align:center; ">ชื่อ-สกุล ตำแหน่ง ชั้น</th>
                            <th width="10%" style="text-align:center; ">เลขที่ขออนุมัติเดินทาง</th>
