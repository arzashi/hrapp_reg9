<script src="<?php echo base_url(); ?>asset/js/pages/work_report/approve_level1.js"></script>
<section class="content">
    <div class="row">
        <div class="box box-solid">
			<div class="box-header " >
				<i class="fa fa-check"></i>
				<h3 class="box-title"> รับทราบรายงานปฏิบัติงาน(หัวหน้า)</h3>
			</div>
					...
					<?php
						foreach ($workReports as $workReport) {
							echo "<tr><td>". $workReport->create_by . 
								...
								"</td><td><div class='form-group'><div class='radio'><label><input type='radio' name='work_type_" . $workReport->id . "' id='work_type_" . $workReport->id . "_1' value='1'>เรียน ผอ." . $_SESSION["Mydiv_name"] . "   เพื่อโปรดนำเรียน ผอ.กปภ.ข.1  ทราบรายงานการเดินทางให้ต่อไปด้วย </label></div></div>".
