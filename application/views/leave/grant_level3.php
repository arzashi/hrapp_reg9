<script src="<?php echo base_url(); ?>asset/js/pages/leave/grant_leave3.js"></script>
<section class="content">
    <div class="row">
        <div class="box box-solid">
			<div class="box-header " >
				<i class="fa fa-check-square-o"></i>
				<h3 class="box-title"> อนุมัติการลา(ผอ เขต)</h3>
			</div>
                ...
                <table id="tbl" class="table table-bordered table-hover" style="width:150%; max-width:150%">
					...
					<?php
						foreach ($pendingLeaves as $pendingLeave) {
							...
							{
								$leaveYesText = "อนุญาตการลา อนุมัติแต่งตั้งรักษาการตามเสนอ";
							...
							echo "<tr><td>". $pendingLeave->username . 
								...
								"</td><td><div class='form-group'><div class='radio'><label><input type='radio' name='leave_type_" . $pendingLeave->leave_id . "' id='leave_type_" . $pendingLeave->leave_id . "_1' value='1'>" . $leaveYesText ."</label></div><div class='radio'><label><input type='radio' name='leave_type_" . $pendingLeave->leave_id . "' id='leave_type_" . $pendingLeave->leave_id . "_0' value='0'>" . $leaveNoText . " </label></div></div>".
