<script src="<?php echo base_url(); ?>asset/js/pages/work/grant_work1.js"></script>
<section class="content">
    <div class="row">
        <div class="box box-solid">
			<div class="box-header " >
				<i class="fa fa-check"></i>
				<h3 class="box-title"> รับทราบอนุมัติเดินทาง(หัวหน้า)</h3>
			</div>
					...
					<?php
						foreach ($pendingWorks as $pendingWork) {
							echo "<tr><td>". $pendingWork->docno . 
								...
								"</td><td><div class='form-group'><div class='radio'><label><input type='radio' name='work_type_" . $pendingWork->id . "' id='work_type_" . $pendingWork->id . "_1' value='1'>เรียน ผอ." . $_SESSION["Mydiv_name"] . " เพื่อโปรดนำเรียน ผอ.กปภ.ข.1  อนุมัติการเดินทางให้ต่อไปด้วย </label></div><div class='radio'><label><input type='radio' name='work_type_" . $pendingWork->id . "' id='work_type_" . $pendingWork->id . "_0' value='0'>ไม่เห็นควรให้เดินทางไปปฏิบัติราชการ </label></div></div>".
